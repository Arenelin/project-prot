...
const file_proto_user_user_proto_rawDesc = "" +
	...
	"\x12DeleteUserResponse2\xbb\x02\n" +
	"\vUserService\x12+\n" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB/Z-github.com/Arenelin/project-protos/proto/userb\x06proto3"
